...
Menu::Menu(float width, float height){
    ...
    menu[0].setPosition(sf::Vector2f((width / 2) - 120, height/(MAX_NUMBER_OF_ITEMS + 1) * 1));
    
    menu[1].setFont(font);
    menu[1].setColor(sf::Color::White);
    menu[1].setCharacterSize(100);
    menu[1].setString("Opciones");
    menu[1].setPosition(sf::Vector2f((width / 2) - 120, height/(MAX_NUMBER_OF_ITEMS + 1) * 2));
    
    menu[2].setFont(font);
    menu[2].setColor(sf::Color::White);
    menu[2].setCharacterSize(100);
    menu[2].setString("Salir");
    menu[2].setPosition(sf::Vector2f((width / 2) - 120, height/(MAX_NUMBER_OF_ITEMS + 1) * 3));
