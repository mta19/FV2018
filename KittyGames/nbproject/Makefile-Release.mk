...
${OBJECTDIR}/AlienRojo.o: AlienRojo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlienRojo.o AlienRojo.cpp
...
${OBJECTDIR}/BalaPistola.o: BalaPistola.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BalaPistola.o BalaPistola.cpp
...
${OBJECTDIR}/Escalera.o: Escalera.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escalera.o Escalera.cpp

${OBJECTDIR}/Escopeta.o: Escopeta.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escopeta.o Escopeta.cpp
...
${OBJECTDIR}/Sprite2D.o: Sprite2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sprite2D.o Sprite2D.cpp
